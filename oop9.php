...
/* 
    ...
    - sama seperti kelas abstrak, bedanya adalah di dalam kelas interface
        tidak boleh ada properti dan juga methodnya hanya boleh didefinisikan
        saja
    
    - namun method yang telah dibuat di dalam interface bisa dikembangkan
        di dalam kelas turunannya dan ini bersifat WAJIB

    - dalam pendeklarasian method di interface harus dalam keadaan public
        
    - untuk melakukannya bisa dilihat pada baris ke - 
*/
...
interface getInfoProduk
{
    ...
    /* 
        ...
        getInfoProduct dipindah jadi method interface
    */
}
